        ...
        return (
            <nav className='navbar'>
                <div className="navbar-items">
                    ...
                    <ul className="items">
                        <li>
                            <a href="#" className="active"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house-door" viewBox="0 0 16 16">
                        ...
                        <li>
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cast" viewBox="0 0 16 16">
