...
class Navbar extends Component {
    constructor(props){
        super(props)
        this.state = {openSearchBox:false}
    }
    ...
    render() {
        return (
            <nav className='navbar'>
                ...
                <div className="item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16" onClick={this.setState({openSearchBox:true})}>
